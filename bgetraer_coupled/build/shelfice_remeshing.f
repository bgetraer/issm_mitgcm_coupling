...
C     mergeFacS :: merging weight for V component velocity
      ...
      Real*8 mergeFacC(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2,nSx,nSy)
      Real*8 mergeFacW(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2,nSx,nSy)
      Real*8 mergeFacS(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2,nSx,nSy)
CEOP
