...
CEOP
     ...
     &     SHELFICESubglFluxFile, SHELFICESubglFluxTimeDepFile,      
     &     SHELFICEDynMassOnly,
     &     SHELFICEadvDiffHeatFlux,
...
C Set defaults values for parameters in SHELFICE.h
      ...
      SHELFICEptracConc        = 0.D0
      shelfice_forcing_period  = 0.D0
      shelfice_extern_forcing_cycle = 0.D0
      ...
      SHELFICEsplitThreshold   = hFacMin*1.1D0 + 1.D0
      SHELFICEmergeThreshold   = hFacMin*0.9D0
